...
| `test_rate_limit.py` | No es un requisito explícito de §2.9, pero protege el comportamiento de "absorber ráfagas" relacionado con §2.11 — confirma que el middleware corta en el umbral configurado, no solo que existe. |
